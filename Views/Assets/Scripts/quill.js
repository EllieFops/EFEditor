...
!function (e)
{
  if ("object" == typeof exports && "undefined" != typeof module) {
    ...
    "undefined" != typeof window
      ...
      ? f = global
      : "undefined" != typeof self && (f = self), f.Quill = e()
  }
}(function ()
{
              ...
              if (!isArr) {
                ...
                if (aWrapped || bWrapped) {
                  return baseIsEqual(aWrapped ? a.__wrapped__ : a, bWrapped
                    ? b.__wrapped__
                    : b, callback, isWhere, stackA, stackB);
                }
      ...
      function (_dereq_, module, exports)
      {
        ...
        Delta.prototype.diff = function (other)
        {
          var strings = [this.ops, other.ops].map(function (ops)
          {
            ...
            {
              if (is.string(op.insert)) {
                return op.insert;
              }
              if (is.number(op.insert)) {
            ...
            _.each(lines, (function (_this)
            {
              return function (line, index)
              {
                ...
                while (line.node !== lineNode) {
                  if (line.node.parentNode === _this.root || ((_ref = line.node.parentNode) != null
                      ? _ref.parentNode
                      : void 0) === _this.root) {
        ...
        Format = (function ()
        {
          ...
          Format.prototype.add = function (node, value)
          {
            ...
            if (_.isString(this.config.parentTag)) {
              ...
              if (node.parentNode.tagName === ((_ref = node.parentNode.previousSibling) != null
                  ? _ref.tagName
                  : void 0)) {
                dom(node.parentNode.previousSibling).merge(node.parentNode);
              }
              if (node.parentNode.tagName === ((_ref1 = node.parentNode.nextSibling) != null
                  ? _ref1.tagName
                  : void 0)) {
          ...
          Format.prototype.match = function (node)
          {
            ...
            if (_.isString(this.config.parentTag) && ((_ref = node.parentNode) != null
                ? _ref.tagName
                : void 0) !== this.config.parentTag) {
              return false;
            }
      ...
      function (_dereq_, module, exports)
      {
        ...
        Toolbar = (function ()
        {
          ...
          function Toolbar(quill, options)
          {
            ...
            this.container = _.isString(this.options.container)
